; (function ($) {
    $.fn.denihanToggle = function (options) {
        ...
        var settings = $.extend({
            ...
            onMode: function($trigger,target) { $(target).animate({ opacity: 1 }, { duration: 200 }); $trigger.attr("data-denihan-mode", "on"); },
            offMode: function($trigger,target) { $(target).animate({ opacity: 0 }, { duration: 200 }); $trigger.attr("data-denihan-mode", "off"); },
